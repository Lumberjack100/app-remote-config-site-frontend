...
- `API_BASE_URL`: API 基础 URL，例如 https://miyitong-remote-config-api.lumberjack2.com/api/v1
- `AUTH_TOKEN_KEY`: 认证 Token 存储键名，例如 auth_token
- 其他项目所需环境变量
...
1. **Project Name**: 输入项目名称，如 `miyitong-remote-config-frontend`
